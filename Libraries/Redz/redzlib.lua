...
local CoreGui: ScreenGui | CoreGui = (gethui and gethui()) or game:GetService("CoreGui")
...
local UIScale: number = ViewportSize.Y / 450

local Settings: table = redzlib.Settings
local Flags: table = redzlib.Flags
...
local SetProps, SetChildren, InsertTheme, Create do
	...
	local function GetFullPath(file)
		return "Someone Hub/Libraries/Redz Library/" .. file
	end
	
	local function Save(file)
		local fullPath: string = GetFullPath(file)
		if readfile and isfile and isfile(fullPath) then
			local decode: table? = HttpService:JSONDecode(readfile(fullPath):gsub("^%-%-%[%[.-%]%]%%-%-%s*\n?", ""))
			...
			if writefile then
				writefile(fullPath, "--[[Modificado Por Someone E Equipe]]--\n" .. HttpService:JSONEncode(redzlib.Save))
			end
		end
	end
...
local Funcs = {} do
	...
	function Funcs:GetConnectionFunctions(ConnectedFuncs, func)
		local Connected: table = { Function = func, Connected = true }
...
function redzlib:MakeWindow(Configs)
	...
	function Window:MakeTab(paste, Configs)
		...
		function Tab:AddParagraph(Configs)
			...
			local PDesc = Configs[2] or Configs.Description or Configs.Text or ""
