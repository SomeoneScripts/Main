...
function redzlib:SetTheme(NewTheme)
	...
	SaveJson("Vortex Lib.json", redzlib.Save)
...
function redzlib:AddWindow(Configs)
	local WTitle = Translate(Configs[1] or Configs.Name or Configs.Title or "Vortex Library V5")
	local WMiniText = Translate(Configs[2] or Configs.SubTitle or "by : redz9999")
	...
	function Window:CloseBtn()
		local Dialog = Window:Dialog({
			...
			Text = Translate("You Want Close Ui?"),
			Options = {
				{"Confirm", function()
					ScreenGui:Destroy()
				end},
	...
	function Window:AddMinimize(Configs)
	...
	function Window:Dialog(Configs)
		...
		local DTitle = Translate(Configs[1] or Configs.Title or "Dialog")
		local DText = Translate(Configs[2] or Configs.Text or "This is a Dialog")
		...
		function Dialog:Button(Configs)
			local Name = Translate(Configs[1] or Configs.Name or Configs.Title or "")
	...
	local ContainerList = {}
	function Window:AddTab(paste, Configs)
		if type(paste) == "table" then Configs = paste end
		local TName = Translate(Configs[1] or Configs.Title or "Tab!")
		...
		function Tab:AddSection(Configs)
			local SectionName = Translate(type(Configs) == "string" and Configs or Configs[1] or Configs.Name or Configs.Title or Configs.Section)
		...
		function Tab:AddParagraph(Configs)
			local PName = Translate(Configs[1] or Configs.Title or "Paragraph")
			local PDesc = Translate(Configs[2] or Configs.Description or Configs.Text or "")
		...
		function Tab:AddButton(Configs)
			local BName = Translate(Configs[1] or Configs.Name or Configs.Title or "Button!")
			local BDescription = Translate(Configs.Desc or Configs.Description or "")
		...
		function Tab:AddToggle(Configs)
			local TName = Translate(Configs[1] or Configs.Name or Configs.Title or "Toggle")
			local TDesc = Translate(Configs.Desc or Configs.Description or "")
		...
		function Tab:AddDropdown(Configs)
			local DName = Translate(Configs[1] or Configs.Name or Configs.Title or "Dropdown")
			local DDesc = Translate(Configs.Desc or Configs.Description or "")
		...
		function Tab:AddSlider(Configs)
			local SName = Translate(Configs[1] or Configs.Name or Configs.Title or "Slider!")
			local SDesc = Translate(Configs.Desc or Configs.Description or "")
		...
		function Tab:AddTextBox(Configs)
			local TName = Translate(Configs[1] or Configs.Name or Configs.Title or "Text Box")
			local TDesc = Translate(Configs.Desc or Configs.Description or "")
			local TDefault = Configs[2] or Configs.Default or ""
			local TPlaceholderText = Translate(Configs[5] or Configs.PlaceholderText or "Input")
		...
		function Tab:AddDiscordInvite(Configs)
			local Invite = Configs[1] or Configs.Invite or "2HUvKP63Jw"
			
			r = http.request({
				Url = "https://discord.com/api/v9/invites/"..Invite.."?with_counts=true&with_expiration=true",
				Method = "GET",
				Headers = {
					["User-Agent"] = "Mozilla/5.0",
				},
			})
			local Body = game.HttpService:JSONDecode(r.Body)
			
			local Title = Body.guild.name or "Discord"
			local Desc = Translate(Body.guild.description).."\n"..Translate("Online Count: ")..Body.approximate_presence_count.."\n"..Translate("Member Count: ")..Body.approximate_member_count or ""
		...
		function Tab:AddGame(Configs)
			local PlaceId = Configs[1] or Configs.PlaceId or game.PlaceId
			...
			local FrameHolder = InsertTheme(Create("Frame", GameHolder, {
				Size = UDim2.new(1, 0, 0, 65),
				AnchorPoint = Vector2.new(0, 1),
				Position = UDim2.new(0, 0, 1),
				BackgroundColor3 = Theme["Color Hub 2"]
			...
			local Game = {}
			function Game:Destroy() GameHolder:Destroy() end
			function Game:Visible(...) Funcs:ToggleVisible(GameHolder, ...) end
			return Game
		end
		return Tab
	end
