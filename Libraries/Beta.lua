...
function Translate(phrase)
    if Settings and Settings.Translate and Settings.Language and Languages[Settings.Language] then
        local lang = Languages[Settings.Language]
        local encoded = HttpService:UrlEncode(phrase)
        local r = http.request({
            Url = "https://translate.googleapis.com/translate_a/single?client=gtx&sl=auto&tl=" .. lang .. "&q=" .. encoded,
            Method = "GET",
            Headers = {
