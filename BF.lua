	...
	function UpdateEliteStatus()
	    ...
	    local ProgressText = Translate("Elite Hunter Spawned: None").." | "..Translate("Progress")..": "..CommF_("EliteHunter", "Progress")
	    if Countdown > 0 then
	...
	task.spawn(function()
		while task.wait() do
			...
			if _G.FarmNearest then
			    ...
			    for _, Enemy in pairs(Enemies:GetChildren()) do
			        if Enemy:FindFirstChildOfClass("Humanoid") and Enemy.Humanoid.Health > 0 then
			            local Distance = (Enemy:GetPivot().Position - HRP.Position).Magnitude
	...
	FruitsData = {
		...
		["rbxassetid://15123638064"] = {Name = "Tiger Fruit", Image = "rbxassetid://129916924163974", Rarity = "Mythical"},
	...
	ChestsData = {
		["SilverChest"] = {Name = "Silver Chest", Color = "rgb(192, 192, 192)"},
		["GoldChest"] = {Name = "Gold Chest", Color = "rgb(255, 215, 0)"},
		["DiamondChest"] = {Name = "Diamond Chest", Color = "rgb(0, 255, 255)"},
		["FragmentChest"] = {Name = "Fragments Chest", Color = "rgb(153, 0, 120)"},
	}
